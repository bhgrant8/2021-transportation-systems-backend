...
setup(
    ...
    version=version,
    description="""Your project description goes in here""",
    long_description=readme + '\n\n' + history,
    long_description_content_type='text/x-rst',
    author='Brian Grant',
    author_email='you@example.com',
    url='https://github.com/hackoregon/2021-transportation-systems-backend',
    packages=setuptools.find_namespace_packages(include=['namespace.*']),
    include_package_data=True,
    license="MIT",
    zip_safe=False,
    keywords='2021-transportation-systems-backend',
    install_requires=[
        'djangorestframework',
